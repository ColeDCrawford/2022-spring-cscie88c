  ...
  "UniversityEmployee" when {
    "instantiated" should {
      "description method should contain name" in {
        // true shouldBe true
        val cole: UniversityEmployee =
          new UniversityEmployee("Cole", "cole_crawford@fas.harvard.edu")
        val fred: UniversityEmployee =
          new UniversityEmployee("Fred", "fred@gmail.com")
