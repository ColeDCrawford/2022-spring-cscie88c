  ...
  "Administrator" when {
    "instantiated" should {
      "include name in the description string" in {
        val gretchen : Administrator = new Administrator("Gretchen", "gretchen@fas.harvard.edu", 32453789)
        val robin_kelsey : Administrator = new Administrator("Robin Kelsey", "robin@fas.harvard.edu", 32453789)
      ...
      "include budget in the description string" in {
        val alan : Administrator = new Administrator("Alan Wolf", "alan@harvard.edu", 4536781)
        val robin_kelsey : Administrator = new Administrator("Robin Kelsey", "robin@fas.harvard.edu", 32453789)
